...
//  массив уже отсоортирован, асимптотика поиска МАКСИМАЛЬНОГО значения равна O(1). |
//  Асимптотика удаления последнего (он же НАИБОЛЬШИЙ, так как массив у нас отсор-  |
//  тирован) тоже равна O(1).                                                       |
//      ОТВЕТ: Но ман нужно еще и БЫСТРО вставлять вновь прибывший элемент, а он    |
...
//              /    _\____                                                         |
//             *    |  *   |                                                        |
//            / \   | / \  | <-Если рассмотреть произольный эемент отдельно будет   |
//           *   *  |*   * | ясно, что его вершина явно содержит БОЛЬШИЙ элемент    |
//          / \ / \ /------  по отношению к его ветвям. По правилам транзитивности, |
//         *  * * * *        если a > b, а b > c => a > c. Значит нам не нужно явно |
//                           проверять, что вершина всего дерева содержит элемент   |
//                           БОЛЬШЕ элемента в вершине произвольного куска дерева.  |
...
//      Теперь представим, что прищло число 7 и нам нужно вставить его в массив в   |
//  нужное место. Сначала ставим его в конец массива, а значит на новую ветку       |
...
//  Получается, что в наиходшем случае асимптотика вставки элемента в дереве равна  |
//  O(H), где Н - высота дерева. Высота дерева равна расстоянию от корня дерева до  |
//  самой удаленной вершины.                                                        |
//                                                                                  |
...
//  H - высота дерева. Отказавшись от сортированного массива мы немного потеряли    |
