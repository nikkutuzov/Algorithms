...
//  Начианем сортировку:                                                            |
//                                                                                  |
//  Пробегаем по индексам, начиная с ПЕРВОГО ( НЕ НУЛЕВОГО! ) и сравниваем с РОДИ-  |
//  ТЕЛЬСКИМИ, тем самым перемещая самый БОЛЬШОЙ наверх.                            |
...
//      Индексы становятся равны: текущий - 0, левый - 1, правый - 2. top = 7       |
//                                                                                  |
//  и так пока не упорядочится весь массив...                                       |
//__________________________________________________________________________________|
