...
//      }                                                                           |
//                                                                                  |
//  Для примера возмем факториал пяти! 5!                                           |
//                                                                                  |
//  1. вызывается функция с параметром 5 factorial(5)                               |
//  2. выполняется проверка if (inputNumber == 0) 5 != 0, значит переходим к else   |
//  3. выполняем return factorial(5 - 1) * 5                                        |
//  4. вызывается функция с параметром 4 factorial(4)                               |
//  5. выполняется проверка if (inputNumber == 0) 4 != 0, значит переходим к else   |
//  6. выполняем return factorial(4 - 1) * 4                                        |
//  7. вызывается функция с параметром 3 factorial(3)                               |
//  8. выполняется проверка if (inputNumber == 0) 3 != 0, значит переходим к else   |
//  9. выполняем return factorial(3 - 1) * 3                                        |
//  10. вызывается функция с параметром 2 factorial(2)                              |
//  11. выполняется проверка if (inputNumber == 0) 2 != 0, значит переходим к else  |
//  12. выполняем return factorial(2 - 1) * 2                                       |
//  13. вызывается функция с параметром 1 factorial(1)                              |
//  14. выполняется проверка if (inputNumber == 0) 1 != 0, значит переходим к else  |
//  15. выполняем return factorial(1 - 1) * 1                                       |
//  16. вызывается функция с параметром 0 factorial(0)                              |
//  17. выполняется проверка if (inputNumber == 0) 5 РАВНО 0, значит return 1 в     |
//      функцию factorial(1)                                                        |
//  19. так как функция factorial(1-1)*1 была вызвана из секции else, то выполняется|
//      return 1 * 1. Это значение возвращается в вызвавшую ее, то есть factorial(2)|
//  20. так как функция factorial(2-1)*2 была вызвана из секции else, то выполняется|
//      return 1 * 2. Это значение возвращается в вызвавшую ее, то есть factorial(3)|
//  21. так как функция factorial(3-1)*3 была вызвана из секции else, то выполняется|
//      return 2 * 3. Это значение возвращается в вызвавшую ее, то есть factorial(4)|
//  22. так как функция factorial(4-1)*4 была вызвана из секции else, то выполняется|
//      return 6 * 4. Это значение возвращается в вызвавшую ее, то есть factorial(5)|
//  23. так как функция factorial(5-1)*5 была вызвана из секции else, то выполняется|
//      return 24 * 5. Это значение возвращается в вызвавшую ее, то есть в main()   |
//                                                                                  |
//__________________________________________________________________________________|
