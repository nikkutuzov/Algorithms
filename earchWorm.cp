...
//                                                                                  |
//  1.  РАССМАТРИВАТЬ БУДЕТ НЕ СЛОЖЕНИЕ, А ПРОИЗВЕДЕНИЕ ДВУХ ЧИСЕЛ                  |
//  2.  ЕЩЕ МЫ ЗАДАДИМ УСЛОВИЕ - ЧТО РАССМАТРИВАЮТСЯ ДЛЯ СРАВНЕНИЯ ТОЛЬКО           |
//  ПРОИЗВЕДЕНИЯ,ДАЮЩИЕ В ИТОГЕ ЧЕТНЫЕ ЧИСЛА                                        |
//  3.  ВСЕ ДАННЫЕ: КОЛИЧЕСТВО ВХОДЯЩИХ ЧИСЕЛ, САМИ ЧИСЛА, РАЗМЕР ОЧЕРЕДИ (ЧЕРВЯКА) |
//  ПОЛЬЗОВАТЕЛЬ БУДЕТ ВВОДИТ С КЛАВИАТУРЫ                                          |
//  4.  ЕСЛИ ТАКАЯ ПАРА НЕ НАШЛАСЬ - БУДЕМ ВЫВОДИТЬ СООТВЕТССТВУЮЩЕЕ СООБЩЕНИЕ      |
//__________________________________________________________________________________|
