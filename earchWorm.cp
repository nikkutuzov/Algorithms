...
//                         |_=============_|                                        |
//                                                                                  |
//  Такой проход по очереди будем осуществлять сдвигом индекса элемента в очереди.  |
//  А когда дойдем до конца этой очереди - не всего списка чисел, а только червя -  |
//  просто обнулим индекс - перейдем на начало очереди (червяка).                   |
//                                                                                  |
