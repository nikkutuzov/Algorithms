...
//  0 - 1 штук         можем              key[0] = 1                                |
//  1 - 2 штук      представить           key[1] = 2                                |
//  2 - 5 штук         их как             key[2] = 5                                |
//  3 - 4 штук        массив с            key[3] = 4                                |
...
//                                                                                  |
//  НО! Если вдруе у нас будет вот такой ряд, то нам нужно более 2 миллионов        |
//  счетчиков:                                                                      |
//                          76  5   2'345'678                                       |
...
//  сортируем массив (+ 1 - чтобы макс. число включительно)
...
//  сортируем массив методом сртировки подсчетом
void countSort(int arr[], int arrLength, int numberLimit) {
