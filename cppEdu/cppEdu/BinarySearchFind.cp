...
//              Бинарный поиск НОВАЯ РЕДАКЦИЯ - с ответом - есть элемент            |
//              и если есть то коков его индекс или элемента нет вовсе.             |
//                                                                                  |
...
//              ПОКА ПРАВАЯ ГРАНИЦА - ЛЕВАЯ ГРАНИЦА БОЛЬШЕ ЕДИНИЦЫ:                 |
...
//              левая граница становится равна середине(middle) - 4, то есть мы     |
//              просто отбрасываем ту половину, в которой его быть не может         |
//            - (6 < 5) - нет => right = 4                                          |
...
//              левая граница становится равна середине(middle) - 1, то есть мы     |
//              просто отбрасываем ту половину, в которой его быть не может         |
//            - (3 < 5) - да => left = 1                                            |
//            - проверяем условие while (4 - 1)) > 1                                |
...
//            - если число под индексом middle меньше искомого числа (5), то        |
//              левая граница становится равна середине(middle) - 2, то есть мы     |
//              просто отбрасываем ту половину, в которой его быть не может         |
//            - (3 < 5) - да => left = 2                                            |
...
//            - если число под индексом middle меньше искомого числа (5), то        |
//              левая граница становится равна середине(middle) - 3, то есть мы     |
//              просто отбрасываем ту половину, в которой его быть не может         |
//            - (4 < 5) - да => left = 3                                            |
...
// елси элемент есть - возвращаем первый слева индекс
...
int findElement(int arr[], int arrLength, int desiredNumber) {
    ...
    // элемента, если таковой есть или слева от того мест, где
    ...
    // первое условие ложь, второе проверятся не будет!!!
